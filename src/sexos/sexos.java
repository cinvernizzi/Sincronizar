 ...
 * los datos de la tabla de sexos, provee también 
 ...
 */
public class sexos extends JComboBox<Object>{
    ...
    private void cargaDiccionario(){
        ...
        Consulta = "SELECT sexos.id AS id, " +
                   "       sexos.sexo " +
                   "FROM sexos " +
                   "ORDER BY sexos.sexo; ";
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getInt("id"),Resultado.getString("sexo")));
