 ...
 * los datos de la tabla de tipos de derivación, provee también 
 ...
 */
public class derivacion extends JComboBox<Object>{
    ...
    private void cargaDiccionario(){
        ...
        Consulta = "SELECT derivacion.id AS id, " +
                   "       derivacion.derivacion AS derivacion " +
                   "FROM derivacion " +
                   "ORDER BY derivacion.derivacion; ";
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getInt("id"),Resultado.getString("derivacion")));
