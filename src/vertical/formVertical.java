 ...
 * verticales y los eventos del mismo
 * 
 * Atención en una primera instancia intenté heredar la 
 * clase de pacientes y luego sobrecargar los métodos 
 * propios de vertical, pero terminaba siendo muy 
 * confuso el código 
 * 
 */
...
public class formVertical{
    ...
    protected formpacientes Madre;

    /**
     * @author Claudio Invernizzi <cinvernizzi@dsgestion.site>
     * @param Contenedor el panel del tabulador
     * @param madre el formulario de la madre
    ...
    public formVertical(JPanel Contenedor, formpacientes madre){
        ...
        // seteamos el formulario de la madre (que es el de pacientes)
        this.Madre = madre;
    ...
    /**
     * @author Claudio Invernizzi <cinvernizzi@dsgestion.site>
     * @return idmadre - clave del registro adulto
     * Método que retorna la clave de la madre adulta del 
     * paciente vertical que tenemos en pantalla
     */
