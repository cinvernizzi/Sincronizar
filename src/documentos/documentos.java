 ...
 * los datos de la tabla de tipos de documento, provee también 
 ...
 */
public class documentos extends JComboBox<Object>{
    ...
    private void cargaDiccionario(){
        ...
        Consulta = "SELECT documentos.id AS id, " +
                   "       documentos.documento AS documento " +
                   "FROM documentos " +
                   "ORDER BY documentos.documento; ";
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getInt("id"),Resultado.getString("documento")));
