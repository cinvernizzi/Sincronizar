 ...
 * los datos de la tabla de instituciones asistenciales, provee 
 * también los métodos para leer los valores seleccionados
 * 
 */
 ...
 */
public class instituciones extends JComboBox<Object>{
    ...
    /**
     * @author Claudio Invernizzi <cinvernizzi@dsgestion.site>
     * @param codloc string con la clave indec de la localidad
     * Método llamado desde el constructor que obtiene el 
     * vector con los elementos a agregar
     */
    public void cargaDiccionario(String codloc){
        ...
        Consulta = "SELECT instituciones.id AS id, " +
                   "       instituciones.nombre AS institucion " +
                   "FROM instituciones " +
                   "WHERE instituciones.localidad = ? " +
                   "ORDER BY instituciones.nombre; ";
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getInt("id"),Resultado.getString("institucion")));
