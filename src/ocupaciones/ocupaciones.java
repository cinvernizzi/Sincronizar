 ...
 * los datos de la tabla de ocupaciones, provee también 
 ...
 */
public class ocupaciones extends JComboBox<Object>{
    ...
    private void cargaDiccionario(){
        ...
        Consulta = "SELECT ocupaciones.id AS id, " +
                   "       ocupaciones.ocupacion AS ocupacion " +
                   "FROM ocupaciones " +
                   "ORDER BY ocupaciones.ocupacion; ";
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getInt("id"),Resultado.getString("ocupacion")));
