 ...
 * los datos de la tabla de motivos de consulta, provee también 
 ...
 */
public class motivos extends JComboBox<Object>{
    ...
    private void cargaDiccionario(){
        ...
        Consulta = "SELECT motivos.id AS id, " +
                   "       motivos.motivo AS motivo " +
                   "FROM motivos " +
                   "ORDER BY motivos.motivo; ";
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getInt("id"),Resultado.getString("motivo")));
