 ...
 * los datos de la tabla de estados civiles, provee también 
 ...
 */
public class estados extends JComboBox<Object>{
    ...
    private void cargaDiccionario(){
        ...
        Consulta = "SELECT estado_civil.id AS id, " +
                   "       estado_civil.estado_civil AS estado " +
                   "FROM estado_civil " +
                   "ORDER BY estado_civil.estado_civil; ";
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getInt("id"),Resultado.getString("estado")));
