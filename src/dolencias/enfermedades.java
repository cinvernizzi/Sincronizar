 ...
 * los datos de la tabla de tipos de enfermedades, provee también 
 ...
 */
public class enfermedades extends JComboBox<Object>{
    ...
    private void cargaDiccionario(){
        ...
        Consulta = "SELECT enfermedades.id AS id, " +
                   "       enfermedades.enfermedad AS enfermedad " +
                   "FROM enfermedades " +
                   "ORDER BY enfermedades.enfermedad; ";
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getInt("id"),Resultado.getString("enfermedad")));
