 ...
 * los datos de la tabla de nacionalidades, provee también 
 ...
 */
public class paises extends JComboBox<Object>{
    ...
    private void cargaDiccionario(){
        ...
        Consulta = "SELECT paises.id AS id, " +
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getInt("id"),Resultado.getString("pais")));
