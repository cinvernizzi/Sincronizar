 ...
 * los datos de la tabla de localidades, provee también 
 ...
 */
public class localidades extends JComboBox<Object>{
    ...
    /**
     * @author Claudio Invernizzi <cinvernizzi@dsgestion.site>
     * @param codprov clave indec de la provincia
     * Método llamado desde el constructor que obtiene el 
     * vector con los elementos a agregar
     */
    public void cargaDiccionario(String codprov){
        ...
        Consulta = "SELECT localidades.codloc AS codloc, " +
                   "       localidades.nomloc AS nomloc " +
                   "FROM localidades " +
                   "WHERE localidades.codpcia = ? " +
                   "ORDER BY localidades.nomloc; ";
    ...
    private void cargaCombo(ResultSet Resultado){
        ...
        try {
            ...
            while (Resultado.next()){
                ...
                this.addItem(new comboClave(Resultado.getString("codloc"),Resultado.getString("nomloc")));
    ...
    /**
     * @author Claudio Invernizzi <cinvernizzi@dsgestion.site>
     * @param codloc texto con la clave de la localidad
     ...
     */
    public void setValor(String codloc, String contenido){

        // instanciamos el combo
        comboClave item = new comboClave(codloc, contenido);
